...
/* @@protoc_insertion_point(class_definition:C2S_CONNECTION_Message) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR C2S_CONNECTION_Message(
 ...
 protected:
  ...
  C2S_CONNECTION_Message(::google::protobuf::Arena* arena, const C2S_CONNECTION_Message& from);
  C2S_CONNECTION_Message(::google::protobuf::Arena* arena, C2S_CONNECTION_Message&& from) noexcept
 ...
 public:
  ...
  void set_allocated_addon_name(std::string* value);
...
/* @@protoc_insertion_point(class_definition:C2S_CONNECT_Message) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR C2S_CONNECT_Message(
      ::google::protobuf::internal::ConstantInitialized);
 ...
 protected:
  ...
  C2S_CONNECT_Message(::google::protobuf::Arena* arena, const C2S_CONNECT_Message& from);
  C2S_CONNECT_Message(::google::protobuf::Arena* arena, C2S_CONNECT_Message&& from) noexcept
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::CCLCMsg_SplitPlayerConnect>* mutable_splitplayers();
  ...
  void set_allocated_auth_steam(std::string* value);
  ...
  void set_allocated_challenge_context(std::string* value);
...
inline std::string* C2S_CONNECT_Message::mutable_encrypted_password() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::RepeatedPtrField<::CCLCMsg_SplitPlayerConnect>* C2S_CONNECT_Message::mutable_splitplayers()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::CCLCMsg_SplitPlayerConnect* C2S_CONNECT_Message::add_splitplayers() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline std::string* C2S_CONNECT_Message::mutable_auth_steam() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* C2S_CONNECT_Message::mutable_challenge_context() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* C2S_CONNECTION_Message::mutable_addon_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
