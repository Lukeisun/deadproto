...
/* @@protoc_insertion_point(class_definition:CEngineGotvSyncPacket) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CEngineGotvSyncPacket(
 ...
 protected:
  ...
  CEngineGotvSyncPacket(::google::protobuf::Arena* arena, const CEngineGotvSyncPacket& from);
  CEngineGotvSyncPacket(::google::protobuf::Arena* arena, CEngineGotvSyncPacket&& from) noexcept
