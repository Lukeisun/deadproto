...
/* @@protoc_insertion_point(class_definition:COAuthToken_ImplicitGrantNoPrompt_Response) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR COAuthToken_ImplicitGrantNoPrompt_Response(
 ...
 protected:
  ...
  COAuthToken_ImplicitGrantNoPrompt_Response(::google::protobuf::Arena* arena, const COAuthToken_ImplicitGrantNoPrompt_Response& from);
  COAuthToken_ImplicitGrantNoPrompt_Response(::google::protobuf::Arena* arena, COAuthToken_ImplicitGrantNoPrompt_Response&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:COAuthToken_ImplicitGrantNoPrompt_Request) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR COAuthToken_ImplicitGrantNoPrompt_Request(
      ::google::protobuf::internal::ConstantInitialized);
 ...
 protected:
  ...
  COAuthToken_ImplicitGrantNoPrompt_Request(::google::protobuf::Arena* arena, const COAuthToken_ImplicitGrantNoPrompt_Request& from);
  COAuthToken_ImplicitGrantNoPrompt_Request(::google::protobuf::Arena* arena, COAuthToken_ImplicitGrantNoPrompt_Request&& from) noexcept
...
inline std::string* COAuthToken_ImplicitGrantNoPrompt_Request::mutable_clientid() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* COAuthToken_ImplicitGrantNoPrompt_Response::mutable_access_token() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* COAuthToken_ImplicitGrantNoPrompt_Response::mutable_redirect_uri() ABSL_ATTRIBUTE_LIFETIME_BOUND {
