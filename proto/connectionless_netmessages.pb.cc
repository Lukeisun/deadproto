...
inline PROTOBUF_NDEBUG_INLINE C2S_CONNECT_Message::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::C2S_CONNECT_Message& from_msg)
...
const ::_pbi::TcParseTable<4, 9, 1, 53, 2> C2S_CONNECT_Message::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(C2S_CONNECT_Message, _impl_._has_bits_),
    0, // no _extensions_
...
::uint8_t* C2S_CONNECT_Message::_InternalSerialize(
  ...
  for (unsigned i = 0, n = static_cast<unsigned>(
                           this->_internal_splitplayers_size());
       i < n; i++) {
...
void C2S_CONNECT_Message::InternalSwap(C2S_CONNECT_Message* PROTOBUF_RESTRICT other) {
  using std::swap;
  auto* arena = GetArena();
...
inline PROTOBUF_NDEBUG_INLINE C2S_CONNECTION_Message::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::C2S_CONNECTION_Message& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 41, 2> C2S_CONNECTION_Message::_table_ = {
  {
    PROTOBUF_FIELD_OFFSET(C2S_CONNECTION_Message, _impl_._has_bits_),
    0, // no _extensions_
...
void C2S_CONNECTION_Message::InternalSwap(C2S_CONNECTION_Message* PROTOBUF_RESTRICT other) {
  using std::swap;
  auto* arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
