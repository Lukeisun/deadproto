...
class UninterpretedOption_NamePart final : public ::google::protobuf::Message
...
class SourceCodeInfo_Location final : public ::google::protobuf::Message
...
class GeneratedCodeInfo_Annotation final : public ::google::protobuf::Message
...
class EnumDescriptorProto_EnumReservedRange final : public ::google::protobuf::Message
...
class DescriptorProto_ReservedRange final : public ::google::protobuf::Message
...
class UninterpretedOption final : public ::google::protobuf::Message
...
class SourceCodeInfo final : public ::google::protobuf::Message
...
class GeneratedCodeInfo final : public ::google::protobuf::Message
...
class ServiceOptions final : public ::google::protobuf::Message
...
class OneofOptions final : public ::google::protobuf::Message
...
class MethodOptions final : public ::google::protobuf::Message
...
class MessageOptions final : public ::google::protobuf::Message
...
class FileOptions final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.FileOptions) */ {
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kAdditionalIncludesFieldNumber = 50,
    kUninterpretedOptionFieldNumber = 999,
  ...
  int additional_includes_size() const;
  private:
  int _internal_additional_includes_size() const;

  public:
  void clear_additional_includes() ;
  const std::string& additional_includes(int index) const;
  std::string* mutable_additional_includes(int index);
  void set_additional_includes(int index, const std::string& value);
  void set_additional_includes(int index, std::string&& value);
  void set_additional_includes(int index, const char* value);
  void set_additional_includes(int index, const char* value, std::size_t size);
  void set_additional_includes(int index, absl::string_view value);
  std::string* add_additional_includes();
  void add_additional_includes(const std::string& value);
  void add_additional_includes(std::string&& value);
  void add_additional_includes(const char* value);
  void add_additional_includes(const char* value, std::size_t size);
  void add_additional_includes(absl::string_view value);
  const ::google::protobuf::RepeatedPtrField<std::string>& additional_includes() const;
  ::google::protobuf::RepeatedPtrField<std::string>* mutable_additional_includes();

  private:
  const ::google::protobuf::RepeatedPtrField<std::string>& _internal_additional_includes() const;
  ::google::protobuf::RepeatedPtrField<std::string>* _internal_mutable_additional_includes();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::RepeatedPtrField<std::string> additional_includes_;
    ::google::protobuf::RepeatedPtrField< ::google::protobuf::UninterpretedOption > uninterpreted_option_;
...
class FieldOptions final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.protobuf.FieldOptions) */ {
 ...
 public:
  ...
  enum : int {
    kUninterpretedOptionFieldNumber = 999,
    kBoxedTypeFieldNumber = 20,
    kSyntheticDefaultFieldNumber = 21,
    kCtypeFieldNumber = 1,
  ...
  bool has_boxed_type() const;
  void clear_boxed_type() ;
  const std::string& boxed_type() const;
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_boxed_type(Arg_&& arg, Args_... args);
  std::string* mutable_boxed_type();
  PROTOBUF_NODISCARD std::string* release_boxed_type();
  void set_allocated_boxed_type(std::string* value);

  private:
  const std::string& _internal_boxed_type() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_boxed_type(
      const std::string& value);
  std::string* _internal_mutable_boxed_type();

  public:
  // optional string synthetic_default = 21;
  bool has_synthetic_default() const;
  void clear_synthetic_default() ;
  const std::string& synthetic_default() const;
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_synthetic_default(Arg_&& arg, Args_... args);
  std::string* mutable_synthetic_default();
  PROTOBUF_NODISCARD std::string* release_synthetic_default();
  void set_allocated_synthetic_default(std::string* value);

  private:
  const std::string& _internal_synthetic_default() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_synthetic_default(
      const std::string& value);
  std::string* _internal_mutable_synthetic_default();
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::RepeatedPtrField< ::google::protobuf::UninterpretedOption > uninterpreted_option_;
    ::google::protobuf::internal::ArenaStringPtr boxed_type_;
    ::google::protobuf::internal::ArenaStringPtr synthetic_default_;
    int ctype_;
    int jstype_;
    bool packed_;
    bool lazy_;
...
class ExtensionRangeOptions final : public ::google::protobuf::Message
...
class EnumValueOptions final : public ::google::protobuf::Message
...
class EnumOptions final : public ::google::protobuf::Message
...
class OneofDescriptorProto final : public ::google::protobuf::Message
...
class MethodDescriptorProto final : public ::google::protobuf::Message
...
class FieldDescriptorProto final : public ::google::protobuf::Message
...
class EnumValueDescriptorProto final : public ::google::protobuf::Message
...
class DescriptorProto_ExtensionRange final : public ::google::protobuf::Message
...
class ServiceDescriptorProto final : public ::google::protobuf::Message
...
class EnumDescriptorProto final : public ::google::protobuf::Message
...
class DescriptorProto final : public ::google::protobuf::Message
...
class FileDescriptorProto final : public ::google::protobuf::Message
...
class FileDescriptorSet final : public ::google::protobuf::Message
...
// repeated string additional_includes = 50;
inline int FileOptions::_internal_additional_includes_size() const {
  return _internal_additional_includes().size();
}
inline int FileOptions::additional_includes_size() const {
  return _internal_additional_includes_size();
}
inline void FileOptions::clear_additional_includes() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.additional_includes_.Clear();
}
inline std::string* FileOptions::add_additional_includes()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  std::string* _s = _internal_mutable_additional_includes()->Add();
  // @@protoc_insertion_point(field_add_mutable:google.protobuf.FileOptions.additional_includes)
  return _s;
}
inline const std::string& FileOptions::additional_includes(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:google.protobuf.FileOptions.additional_includes)
  return _internal_additional_includes().Get(index);
}
inline std::string* FileOptions::mutable_additional_includes(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:google.protobuf.FileOptions.additional_includes)
  return _internal_mutable_additional_includes()->Mutable(index);
}
inline void FileOptions::set_additional_includes(int index, const std::string& value) {
  _internal_mutable_additional_includes()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::set_additional_includes(int index, std::string&& value) {
  _internal_mutable_additional_includes()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::set_additional_includes(int index, const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_additional_includes()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::set_additional_includes(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_additional_includes()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::set_additional_includes(int index, absl::string_view value) {
  _internal_mutable_additional_includes()->Mutable(index)->assign(
      value.data(), value.size());
  // @@protoc_insertion_point(field_set_string_piece:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::add_additional_includes(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_additional_includes()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::add_additional_includes(std::string&& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_additional_includes()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::add_additional_includes(const char* value) {
  ABSL_DCHECK(value != nullptr);
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_additional_includes()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::add_additional_includes(const char* value, std::size_t size) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_additional_includes()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:google.protobuf.FileOptions.additional_includes)
}
inline void FileOptions::add_additional_includes(absl::string_view value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_additional_includes()->Add()->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_add_string_piece:google.protobuf.FileOptions.additional_includes)
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
FileOptions::additional_includes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:google.protobuf.FileOptions.additional_includes)
  return _internal_additional_includes();
}
inline ::google::protobuf::RepeatedPtrField<std::string>*
FileOptions::mutable_additional_includes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:google.protobuf.FileOptions.additional_includes)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_additional_includes();
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
FileOptions::_internal_additional_includes() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.additional_includes_;
}
inline ::google::protobuf::RepeatedPtrField<std::string>*
FileOptions::_internal_mutable_additional_includes() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.additional_includes_;
}
...
// optional string boxed_type = 20;
inline bool FieldOptions::has_boxed_type() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline void FieldOptions::clear_boxed_type() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.boxed_type_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& FieldOptions::boxed_type() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:google.protobuf.FieldOptions.boxed_type)
  return _internal_boxed_type();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void FieldOptions::set_boxed_type(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.boxed_type_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:google.protobuf.FieldOptions.boxed_type)
}
inline std::string* FieldOptions::mutable_boxed_type() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_boxed_type();
  // @@protoc_insertion_point(field_mutable:google.protobuf.FieldOptions.boxed_type)
  return _s;
}
inline const std::string& FieldOptions::_internal_boxed_type() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.boxed_type_.Get();
}
inline void FieldOptions::_internal_set_boxed_type(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.boxed_type_.Set(value, GetArena());
}
inline std::string* FieldOptions::_internal_mutable_boxed_type() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.boxed_type_.Mutable( GetArena());
}
inline std::string* FieldOptions::release_boxed_type() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:google.protobuf.FieldOptions.boxed_type)
  if ((_impl_._has_bits_[0] & 0x00000001u) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* released = _impl_.boxed_type_.Release();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  _impl_.boxed_type_.Set("", GetArena());
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return released;
}
inline void FieldOptions::set_allocated_boxed_type(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
  ...
  _impl_.boxed_type_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.boxed_type_.IsDefault()) {
          _impl_.boxed_type_.Set("", GetArena());
        }
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.protobuf.FieldOptions.boxed_type)
}

// optional string synthetic_default = 21;
inline bool FieldOptions::has_synthetic_default() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline void FieldOptions::clear_synthetic_default() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.synthetic_default_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline const std::string& FieldOptions::synthetic_default() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:google.protobuf.FieldOptions.synthetic_default)
  return _internal_synthetic_default();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void FieldOptions::set_synthetic_default(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.synthetic_default_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:google.protobuf.FieldOptions.synthetic_default)
}
inline std::string* FieldOptions::mutable_synthetic_default() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_synthetic_default();
  // @@protoc_insertion_point(field_mutable:google.protobuf.FieldOptions.synthetic_default)
  return _s;
}
inline const std::string& FieldOptions::_internal_synthetic_default() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.synthetic_default_.Get();
}
inline void FieldOptions::_internal_set_synthetic_default(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.synthetic_default_.Set(value, GetArena());
}
inline std::string* FieldOptions::_internal_mutable_synthetic_default() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.synthetic_default_.Mutable( GetArena());
}
inline std::string* FieldOptions::release_synthetic_default() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:google.protobuf.FieldOptions.synthetic_default)
  if ((_impl_._has_bits_[0] & 0x00000002u) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* released = _impl_.synthetic_default_.Release();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  _impl_.synthetic_default_.Set("", GetArena());
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return released;
}
inline void FieldOptions::set_allocated_synthetic_default(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
  ...
  _impl_.synthetic_default_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.synthetic_default_.IsDefault()) {
          _impl_.synthetic_default_.Set("", GetArena());
        }
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.protobuf.FieldOptions.synthetic_default)
}
